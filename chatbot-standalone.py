...
intencoes = {
    "saudacao": "Olá em que podemos ajudar?",
    ...
    "sem_intencao": "Deseja mais alguma informação?",
    "default": "Desculpa, não entendi o que disse. Sugiro que pergunte sobre valores e forma de pagamento, datas disponíveis, informações sobre o Espaço ou então agendar uma visita."
}
...
print("Olá, tudo bem? Somos do Espaço Shiroma, aqui você poderá tirar dúvidas e solicitar informações sobre o nosso Espaço. Em que posso ser útil?")
...
while True:
    ...
    if (intencao[0] == 'saudacao'):
      ...
      resposta_intencao = msg_data_possibilidade(message, intencoes[intencao[0]])
      print("--- reconhece_entidades ---")
      print(reconhece_entidades(dic_etiquetas_param=dic_etiquetas, msg=msg))
    else:
      resposta_intencao = intencoes[intencao[0]]    
    print(resposta_intencao)
